...
sudo pacman -S arandr alacritty android-file-transfer android-tools feh ca-certificates carla cpio cmake dunst flac flatpak fontconfig fzf gcc gedit gettext gst-plugin-gtk gst-plugin-pipewire gst-plugins-bad gst-plugins-bad-libs gst-plugins-base gst-plugins-base-libs gst-plugins-good gst-plugins-ugly gst-python gstreamer gvim i3-wm i3blocks i3lock i3status isync lynx meson mpd mpv msmtp ncurses neofetch neomutt nm-connection-editor noto-fonts noto-fonts-cjk noto-fonts-emoji numlockx otf-font-awesome otf-libertinus notmuch nsxiv pass pavucontrol pdf2svg picom pipewire pipewire-jack pipewire-pulse pkg-config polybar rxvt-unicode thunar ttf-dejavu ttf-hack ttf-inconsolata ttf-joypixels ttf-liberation ttf-linux-libertine ttf-roboto xclip xdg-desktop-portal xdg-desktop-portal-gtk xdg-desktop-portal-xapp xdg-user-dirs xdg-utils xorg xorg-xinit zathura zathura-djvu zathura-pdf-mupdf || exit
...
sudo pacman -S j4-dmenu-desktop hyprcursor hyprgraphics hyprland hyprland-qt-support hyprland-qtutils hyprlang hyprpaper hyprshot hyprutils hyprwayland-scanner xdg-desktop-portal-hyprland xremap-hypr-bin bemenu bemenu-wayland swaylock waybar wl-clipboard
