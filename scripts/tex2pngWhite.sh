#!/bin/sh
# Execute this script on the tex file you want to generate a white-text png for.
# usage:
...
magick convert -density 1200 -colorspace RGB -channel RGB -negate -trim "$FILE.ps" "$FILE.png" #convert to png
