% I think this may have been a fork of this: https://github.com/benedictdudel/pandoc-letter-din5008 (CC-BY-SA-4.0)
...
\usepackage{xcolor}
% Define a command to switch text color
\newcommand{\startblue}{\begingroup\color{blue}}
\newcommand{\stopblue}{\endgroup}
\newcommand{\startred}{\begingroup\color{red}}
\newcommand{\stopred}{\endgroup}
...
\newcommand{\section}[1]{\par\vspace{1em}\huge\textbf{#1}\normalsize\par\nobreak\vspace{0.5em}\ignorespaces}
\newcommand{\subsection}[1]{\par\vspace{1em}\LARGE\textbf{#1}\normalsize\par\nobreak\vspace{0.5em}\ignorespaces}
\newcommand{\subsubsection}[1]{\par\vspace{1em}\Large\textbf{#1}\normalsize\par\nobreak\vspace{0.5em}\ignorespaces}
